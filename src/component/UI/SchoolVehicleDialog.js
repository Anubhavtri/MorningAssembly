...
const SchoolVehiclelistDialog = ({ visible, visibleFun, myCallback, title, sub_title, data }) => {
    ...
    const renderItem_requested_skill = (item, index) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => {
                    setindex(index);
                    setselected(item.vehicle_id.vehicle_number);
                ...
                <View
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text>{item.vehicle_id.vehicle_number}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        );
...
export default SchoolVehiclelistDialog;
